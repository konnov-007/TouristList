...
public class NewTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        routeET = findViewById(R.id.routeEditText);
        photo = findViewById(R.id.imageViewForNewTour);
        backpackET = findViewById(R.id.backpackEditText);
        durationET = findViewById(R.id.durationEditText);
        weatherET = findViewById(R.id.weatherEditText);
